...
{
    public abstract class CourseTrackerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CourseTrackerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CourseTrackerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CourseTrackerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CourseTrackerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CourseTrackerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CourseTrackerDbContext, Task<T>> func)
        {
            T result;
